...
export interface ChampionsDataDragonDetailsSolo extends ChampionsDataDragonDetails {
  lore: string;
  skins: {
    id: string;
    num: number;
...
export interface ChampionsDataDragon {
...
export interface ChampionDataDragon {
  ...
  readonly version: string;
  readonly data: {
    [key: string]: ChampionsDataDragonDetailsSolo;
  };
}
