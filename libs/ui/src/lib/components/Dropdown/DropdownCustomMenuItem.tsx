...
import { Icon, Text, TouchableRipple, TouchableRippleProps, useTheme } from 'react-native-paper';
import { IconSource } from 'react-native-paper/lib/typescript/components/Icon';

import { MD3Theme } from 'react-native-paper/src/types';
import { getMenuItemColor, MAX_WIDTH, MIN_WIDTH } from './utils';
...
const DropdownCustomMenuItem = ({
  ...
  const theme = useTheme(themeOverrides) as MD3Theme;
...
DropdownCustomMenuItem.displayName = 'Menu.Item';
...
export default DropdownCustomMenuItem;